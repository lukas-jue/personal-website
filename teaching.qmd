...
+--------------+-------------------------------------------------------+
| **Course     | Introduction to Data Science with R and the Tidyverse |
| Name**       |                                                       |
+--------------+-------------------------------------------------------+
| **Course     | Ph.D.                                                 |
| level**      |                                                       |
+--------------+-------------------------------------------------------+
| **I          | Goethe University Frankfurt (GRADE)                   |
| nstitution** |                                                       |
+--------------+-------------------------------------------------------+
...
+--------------+-------------------------------------------------------+
| **Jointly    | Over time, I have taught this course with many great  |
| taught       | colleagues: Lara Zaremba, Karlo Lukic, Matteo Fina,   |
| with**       | and Jan Bischoff                                      |
+--------------+-------------------------------------------------------+
| **Duration** | 3 x 2 hours over three weeks or 1 x 6 hours           |
+--------------+-------------------------------------------------------+
| *            | Summer 2021, Winter 2021/22, Summer 2022, Summer 2023 |
| *Semesters** |                                                       |
+--------------+-------------------------------------------------------+
| **Language** | English                                               |
+--------------+-------------------------------------------------------+
| *            | Link to course materials ([Summer                     |
| *Resources** | 2023](https:/                                         |
|              | /coding-int%20ro.github.io/intro-tidyverse-2023-06/)) |
+--------------+-------------------------------------------------------+
...
|                      | olat/auth/RepositoryEntry/17995235331?12)) |
+----------------------+--------------------------------------------+
...
+-------------+--------------------------------------------------------+
| **Course    | Empirical Customer Analytics --- A Practice-oriented   |
| Name**      | Introduction                                           |
+-------------+--------------------------------------------------------+
| **Course    | Bachelor's                                             |
| level**     |                                                        |
...
| stitution** |                                                        |
+-------------+--------------------------------------------------------+
| **Target    | Advanced undergraduate Business and Economics students |
| group**     |                                                        |
+-------------+--------------------------------------------------------+
| **Role**    | Teaching assistant                                     |
+-------------+--------------------------------------------------------+
...
| *Language** |                                                        |
+-------------+--------------------------------------------------------+
| **          | Link to [course description](https://tinygu.de/7xl10)  |
| Resources** |                                                        |
+-------------+--------------------------------------------------------+
