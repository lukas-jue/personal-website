...
+-------------------------+-------------------------------------------+
| **Course Name**         | Introduction to Data Science with R and   |
|                         | the Tidyverse                             |
+-------------------------+-------------------------------------------+
| **Course level**        | Ph.D.                                     |
+-------------------------+-------------------------------------------+
...
+-------------------------+-------------------------------------------+
| **Target group**        | Doctoral students from STEM fields with   |
|                         | none or little `R` experience             |
+-------------------------+-------------------------------------------+
...
|                         | Karlo Lukic, M.Sc.                        |
+-------------------------+-------------------------------------------+
| **Duration**            | 3 x 2 hours over three weeks or 1 x 6     |
|                         | hours                                     |
+-------------------------+-------------------------------------------+
...
| **Language**            | English                                   |
+-------------------------+-------------------------------------------+
| **Resources**           | Link to course materials ([Summer         |
|                         | 2021](https://lukas-ju                    |
|                         | e.github.io/intro-tidyverse/ "Introductio |
|                         | n to Data Science with R and Tidyverse"), |
|                         | [Winter                                   |
|                         | 2021/22](https://lukas-jue.git            |
|                         | hub.io/intro-tidyverse-2022/ "Introductio |
|                         | n to Data Science with R and Tidyverse"), |
|                         | [Summer                                   |
|                         | 2022](https://lukas-jue                   |
|                         | .github.io/intro-tidyverse-2022-summer/)) |
+-------------------------+-------------------------------------------+
...
language before. This course aims at providing a results-oriented,
...
Our goal is to show you the scope of possibilities within R and leave
you with the impression that you can confidently implement your
empirical projects in R. We will focus on the Tidyverse ecosystem, a
consistent and intuitive framework for building your data analysis from
start to finish. After completing this course, you know how to apply the
...
+------------------+--------------------------------------------------+
| **Semesters**    | Summer 2021, Winter 2021/22, Summer 2022, Winter |
|                  | 2022/23                                          |
+------------------+--------------------------------------------------+
| **Language**     | German                                           |
+------------------+--------------------------------------------------+
| **Resources**    | Link to course materials ([Summer                |
|                  | 2022](https://olat-ce.server.uni-frankf          |
|                  | urt.de/olat/auth/RepositoryEntry/14664237060?3)) |
+------------------+--------------------------------------------------+
