...
|               | 2023](https:/%20/c                                  |
|               | oding-int%20ro.github.io/intro-tidyverse-2023-06/)) |
+---------------+-----------------------------------------------------+
...
|                     | university learning platform ([Summer     |
|                     | 2023](                                    |
|                     | https://olat-ce.server.uni-frankfurt.de/o |
|                     | lat/auth/RepositoryEntry/17995235331?12)) |
+---------------------+-------------------------------------------+
